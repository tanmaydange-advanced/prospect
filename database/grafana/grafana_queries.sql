SELECT "dependency",  "cvss_score", "cvss_severity","current_version", "fix_version" FROM VULNERABILITY WHERE issue_type = 'Security Issue' order by cvss_score DESC,dependency;
